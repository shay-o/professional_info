...
* **Key Projects:**
    ...
    * **Infrastructure & Optimization:** Oversaw *Aeon for AA* (modernized infrastructure with fallback), *Client Hints*, *Geo/Bot/Device lookup*, and streamlined setups for *Omnivore/AEM* and *Content Analytics*.
    * **Problem Solving:** Managed complex technical challenges such as pageview inflation sagas.
...
* **Team Management:** Previously led analytics teams at **Cardlytics** and **Adobe**. Managed data scientists and oversaw the development of automated analysis platforms.
